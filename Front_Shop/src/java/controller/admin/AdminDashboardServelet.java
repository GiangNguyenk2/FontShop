...
public class AdminDashboardServelet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (yearParam != null && !yearParam.isEmpty()) {
            ...
            selectedYear = 2023; // Năm bắt đầu mặc định
        }
        request.setAttribute("year", yearParam);
        int startYear = 2023; // Năm bắt đầu (có thể thay đổi)
        ...
        Map<String, Double> totalMoneyMap = dao.getTotalMoneyByMonth(selectedYear);

        List<Integer> orderCounts = dao.getOrderCountsByMonth(selectedYear);
